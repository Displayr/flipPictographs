...
imageWHRatio <- c(apple=0.884,baby=1.0,banana=1.124,bank=1.039,barn=1.358,
                  ...
                  'face-happy'=1,'face-neutral'=1,'face-sad'=1,fuel=1.431,glass=0.750,globe=1.431,government=0.717,
                  graduation=1.440,gun=1.595,heart=1.052,house=1.052,
                  idea=1.00,law=1,man=0.492,medicine=1,money=1,patient=0.704,
                  ...
                  'symbol-tick'=1, 'symbol-cross'=1, 'symbol-minus'=1, 'symbol-plus'=1,
                  testtube=1,trolley=1.153,thumbsup=1.048,thumbsdown=1.048,tick=1.301,
                  ...
                  happyface=1, neutralface=1, sadface = 1,
                  circle=1, square=1)

image.names <- names(imageWHRatio)
imageURL <- sprintf("https://displayrcors.displayr.com/images/%s_grey.svg", image.names)
