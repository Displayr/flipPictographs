...
imageWHRatio <- c(apple=1,baby=0.8,banana=1,bank=1,barn=1.2,book=1,building=1,
                 church=0.8,citygate=1, cow=1.2,dna=0.5,elephant=1.5,
                 ...
                 soldier=0.5,soup=1,stack=18, star=1,stickman=0.5,stickwoman=0.5,
                 testtube=1,tomato=1,tools=1,trafficlight=0.6,
                 train=0.9,tree=1,truck=1.5,tv=1,user=0.9,waterdrop=0.7,weight=1)
