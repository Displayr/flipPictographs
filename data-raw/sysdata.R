...
imageWHRatio <- c(apple=0.884,baby=1.0,banana=1.124,bank=1.039,barn=1.358,book=1,
                  ...
                  fuel=1.431,globe=1.431,government=0.717,graduation=1.440,
                  gun=1.595,heart=1.052,house=1.052,idea=1.00,law=1,medicine=1,money=1,
                  police=1.0,renewenergy=1.152,road=0.803,rocket=0.803,
