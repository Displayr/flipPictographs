                         ...
                         ...)
{
    ...
    {
        fsc <- 1.3333
        label.data.font.size = round(fsc * label.data.font.size, 2)
        text.above.font.size = round(fsc * text.above.font.size, 2)
        text.below.font.size = round(fsc * text.below.font.size, 2)
        tick.font.size = round(fsc * tick.font.size, 2)
    }
