...
q1c <- PictoStdChart(x1, show.as.column = T)
q1d <- PictoStdChart(x1, show.as.column = T, show.lines=T, show.legend=T)
...
q9b <- PictoStdChart(x9.y, groupBy=x9.x, image="drink", transpose=T)
